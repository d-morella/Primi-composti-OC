...
#this function fills the two stck of the i-th player
...
#initialization 
round = 1
set_of_cards = np.arange(2, 25)
random.shuffle(set_of_cards)
p1_hand = np.sort(set_of_cards[0:11])
p2_hand = np.sort(set_of_cards[12:24])
